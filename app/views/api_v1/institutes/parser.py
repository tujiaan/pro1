...
institutes_parser.add_argument('ins_picture',type=FileStorage,help='机构图片',required=True,location='files')
...
#institutes_parser.add_argument('admin_user_id',type=float,help='机构管理员id',required=False,location='form')
institutes_parser.add_argument('location_id',type=str,help='位置id',required=False,location='form')
